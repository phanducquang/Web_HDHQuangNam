...
$(document).ready(function() {
    ...
    var header = {
        "Authorization": "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxIiwiaWF0IjoxNTc4OTI1MDE2LCJleHAiOjE1ODEwNzAwMTZ9.8WHQjV3D12r6aYFMrNB7R0GxLyNIqljxmWrf8Uwr355DWmfMPZwwHmiqLtBvAKLNzCpB6AtFc0eQuYLR1m4bQA"
    }
    ...
    $("#save_post").click(function() {
        if ($("#chude").val() != "" && $("#tieude").val() != "" && $("#input_tieude").val() != "" && $("#link_thumbnail").val() != "" && CKEDITOR.instances.editor.getData() != "") {
            var obj = {
                ...
                "featured": ($("#featured").val() == true) ? true : false
            }
            var flag = true;
